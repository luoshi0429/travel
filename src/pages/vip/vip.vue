    ...
    <div class="buy-tips-dialog-wrapper" v-show="ruleDialogVisible">
      ...
      <div class="dialog-content">
        ...
        <ol class="buy-tips-list">
          ...
          <li>返现规则:会员账号必须绑定微信号,用绑定账号的微信号,关注公众号:"旅合算",提供有效订单编号截图以及微信收款二维码或支付宝账号.</li>
          <li>返现审核时间为3-5个工作日,审核成功则直接打款,失败则查看我司回复.</li>
          <li>退订方式:普通买断包月一经购买不可退订,连续自动包月用户可退订，可通过我的界面“退订”按钮直接退订，或者在“旅合算”公众号发送退订需求给客服，也可以拨打客服电话进行退订，客服电话020-38371981.</li>
          <li>服务支持:如有投诉或好的建议,可关注我司公众号"旅合算"进行反馈,在收到信息后5个工作日内回复.</li>
        </ol>
      </div>
    </div>
